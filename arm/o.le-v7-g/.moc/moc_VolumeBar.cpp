...
static const char qt_meta_stringdata_VolumeBar[] = {
    "VolumeBar\0\0volumeChanged(double)\0"
    "onVolumeChanged(float)\0"
};

void VolumeBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        VolumeBar *_t = static_cast<VolumeBar *>(_o);
        switch (_id) {
        case 0: _t->volumeChanged((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 1: _t->onVolumeChanged((*reinterpret_cast< float(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData VolumeBar::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VolumeBar::staticMetaObject = {
    { &CustomControl::staticMetaObject, qt_meta_stringdata_VolumeBar,
      qt_meta_data_VolumeBar, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VolumeBar::getStaticMetaObject() { return staticMetaObject; }
...
// SIGNAL 0
void VolumeBar::volumeChanged(double _t1)
{
